...
edb.raw <- read_dta(file.path(PROJHOME, "data/MasterWBMarch16_15.dta")) %>%
...
ggsave(plot.reforms.avg, filename=file.path(PROJHOME, "figures/bureau_reforms_average.pdf"),
       width=5, height=3.5, units="in", device=cairo_pdf)
ggsave(plot.reforms.avg, filename=file.path(PROJHOME, "figures/bureau_reforms_average.png"),
...
ggsave(plot.reforms.total, filename=file.path(PROJHOME, "figures/bureau_reforms_total.pdf"),
       width=5, height=3.5, units="in", device=cairo_pdf)
ggsave(plot.reforms.total, filename=file.path(PROJHOME, "figures/bureau_reforms_total.png"),
       width=5, height=3.5, units="in", type="cairo", dpi=300)
...
ggsave(plot.reforms.positive, filename=file.path(PROJHOME, "figures/bureau_reforms_positive.pdf"),
       width=5, height=3.5, units="in", device=cairo_pdf)
ggsave(plot.reforms.positive, filename=file.path(PROJHOME, "figures/bureau_reforms_positive.png"),
       width=5, height=3.5, units="in", type="cairo", dpi=300)
...
set.seed(1234)
ggsave(plot.rankings.cor, filename=file.path(PROJHOME, "figures/bureau_rankings.pdf"),
       width=5, height=4, units="in", device=cairo_pdf)
set.seed(1234)
ggsave(plot.rankings.cor, filename=file.path(PROJHOME, "figures/bureau_rankings.png"),
...
set.seed(1234)
ggsave(plot.rankings.cor.notitle, filename=file.path(PROJHOME, "figures/bureau_rankings_notitle.pdf"),
       width=5, height=3.5, units="in", device=cairo_pdf)
set.seed(1234)
ggsave(plot.rankings.cor.notitle, filename=file.path(PROJHOME, "figures/bureau_rankings_notitle.png"),
       width=5, height=3.5, units="in", type="cairo", dpi=300)
...
ggsave(plot.reforms.rankings, filename=file.path(PROJHOME, "figures/bureau_reforms_rank.pdf"),
       width=5, height=4, units="in", device=cairo_pdf)
ggsave(plot.reforms.rankings, filename=file.path(PROJHOME, "figures/bureau_reforms_rank.png"),
       width=5, height=4, units="in", type="cairo", dpi=300)
...
ggsave(plot.avg.reforms, filename=file.path(PROJHOME, "figures/bureau_avg_reforms.pdf"),
       width=5, height=3, units="in", device=cairo_pdf)
ggsave(plot.avg.reforms, filename=file.path(PROJHOME, "figures/bureau_avg_reforms.png"),
...
ggsave(plot.avg.reforms.year, filename=file.path(PROJHOME, "figures/bureau_avg_reforms_year.pdf"),
       width=5, height=4, units="in", device=cairo_pdf)
ggsave(plot.avg.reforms.year, filename=file.path(PROJHOME, "figures/bureau_avg_reforms_year.png"),
       width=5, height=4, units="in", type="cairo", dpi=300)
...
ggsave(plot.avg.reforms.rank, filename=file.path(PROJHOME, "figures/bureau_avg_reforms_rank.pdf"),
       width=5, height=2.5, units="in", device=cairo_pdf)
ggsave(plot.avg.reforms.rank, filename=file.path(PROJHOME, "figures/bureau_avg_reforms_rank.png"),
...
ggsave(plot.ranking.cor, filename=file.path(PROJHOME, "figures/bureau_ranking_cor.pdf"),
       width=5, height=3.5, units="in", device=cairo_pdf)
ggsave(plot.ranking.cor, filename=file.path(PROJHOME, "figures/bureau_ranking_cor.png"),
       width=5, height=3.5, units="in", type="cairo", dpi=300)

plot.ranking.cor.notitle <- plot.ranking.cor + labs(title=NULL)
ggsave(plot.ranking.cor.notitle, filename=file.path(PROJHOME, "figures/bureau_ranking_cor_notitle.pdf"),
       width=5, height=3, units="in", device=cairo_pdf)
ggsave(plot.ranking.cor.notitle, filename=file.path(PROJHOME, "figures/bureau_ranking_cor_notitle.png"),
       width=5, height=3, units="in", type="cairo", dpi=300)


change.rankings <- edb.raw %>%
...
edb.reforms.rankings.bumps <- edb.reforms %>%
  ...
  summarise(num.reforms = sum(reform.num.no.na)) %>%
  left_join(change.rankings, by=c("ccode", "year")) %>%
...
edb.reforms.rankings.bumps.summarized <- edb.reforms.rankings.bumps %>%
  filter(change.per.reform1 <= 0) %>%
  group_by(reform.type.clean, has.bureau) %>%
  summarise(avg.bump = mean(change.per.reform1, na.rm=TRUE)) %>%
  ungroup() %>%
...
ggsave(plot.ranking.bumps, filename=file.path(PROJHOME, "figures/bureau_ranking_bumps_all.pdf"),
       width=5, height=3, units="in", device=cairo_pdf)
ggsave(plot.ranking.bumps, filename=file.path(PROJHOME, "figures/bureau_ranking_bumps_negative_bumps_only.png"),
       width=5, height=3, units="in", type="cairo", dpi=300)
...
ggsave(plot.model.rankings.type, filename=file.path(PROJHOME, "figures/bureau_model_rankings.pdf"),
       width=5, height=3.5, units="in", device=cairo_pdf)
ggsave(plot.model.rankings.type, filename=file.path(PROJHOME, "figures/bureau_model_rankings.png"),
       width=5, height=3.5, units="in", type="cairo", dpi=300)
...
ggsave(plot.mix.reforms, filename=file.path(PROJHOME, "figures/bureau_reforms.mix.pdf"),
       width=5, height=3.5, units="in", device=cairo_pdf)
ggsave(plot.mix.reforms, filename=file.path(PROJHOME, "figures/bureau_reforms.mix.png"),
       width=5, height=3.5, units="in", type="cairo", dpi=300)
...
ggsave(plot.model.committee, filename=file.path(PROJHOME, "figures/bureau_model_presence.pdf"),
       width=5, height=3.5, units="in", device=cairo_pdf)
ggsave(plot.model.committee, filename=file.path(PROJHOME, "figures/bureau_model_presence.png"),
       width=5, height=3.5, units="in", type="cairo", dpi=300)
...
ggsave(plot.gaps.lots, filename=file.path(PROJHOME, "figures/bureau_gap_range.pdf"),
       width=5, height=3.5, units="in", device=cairo_pdf)
ggsave(plot.gaps.lots, filename=file.path(PROJHOME, "figures/bureau_gap_range.png"),
       width=5, height=3.5, units="in", type="cairo", dpi=300)
...
ggsave(plot.gaps.dist, filename=file.path(PROJHOME, "figures/bureau_gap_dists.pdf"),
       width=5, height=3.5, units="in", device=cairo_pdf)
ggsave(plot.gaps.dist, filename=file.path(PROJHOME, "figures/bureau_gap_dists.png"),
       width=5, height=3.5, units="in", type="cairo", dpi=300)
...
ggsave(plot.gaps.bureau, filename=file.path(PROJHOME, "figures/bureau_gap_bureau.pdf"),
       width=5, height=3.5, units="in", device=cairo_pdf)
ggsave(plot.gaps.bureau, filename=file.path(PROJHOME, "figures/bureau_gap_bureau.png"),
       width=5, height=3.5, units="in", type="cairo", dpi=300)
